 ...
 * @live_demo   http://gourl.io/lib/examples/pay-per-registration.php
 */ 
...
<html><head>
<title><?= $coinName ?> Pay-Per-Registration Cryptocoin Payment Example</title>
...
<? else: ?>
	...
	<form name='form1' style='font-size:14px;color:#444' action="pay-per-registration.php#i" method="post">
		<table cellspacing='20'>
			<tr><td colspan='2'><b>NEW USER</b><?= $error ?><input type='text' style='display: none'><input type='password' style='display: none'></td></tr>
			<tr><td width='100'>Name: </td><td width='300'><input style='padding:6px;font-size:18px;' size='30' type="text" name="fname" value="<?= $fname ?>"></td></tr>
			<tr><td>Email: </td><td><input style='padding:6px;font-size:18px;' size='40' type="text" name="femail" value="<?= $femail ?>"></td></tr>
			<tr><td>Password: </td><td><input style='padding:6px;font-size:18px;' size='35' type="password" name="fpassword" value="<?= $fpassword ?>"><br><br></td></tr>
		</table>
	</form>

	<div style='width:600px;padding-top:10px'>
			<div style='font-size:12px; margin:5px 0 5px 390px;'>Language: &#160; <?= $languages_list ?></div>
			<?= $box->display_cryptobox(true, 530, 230, "border-radius:15px;border:2px dashed #eee;padding:3px 6px;margin:10px") ?>
	</div>
